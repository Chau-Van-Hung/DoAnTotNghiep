    ...
    public class AccountManageController : Controller
    {
        ...
        public async Task<ActionResult> UpdateAccount(WebmasterInfoDTO accountdto, int typeFix)
        {
            ...
            try
            {
                ...
                {
                    //register
                    var user = new ApplicationUser { UserName = accountdto.WIUserName, Email = accountdto.WIEmail, PhoneNumber = accountdto.WIPhoneNumber, EmailConfirmed = false };
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (role.Equals("candidate"))
                    {
                        ...
                        cdddto.CPStatus = (int?)BU.Common.Enum.StatusCandidate.Active;
                    ...
                    else if (role.Equals("employer"))
                    {
                        ...
                        rcdto.RIStatus = (int?)BU.Common.Enum.StatusRecruit.Active;
                        rcdto.RIPassword = user.PasswordHash;
                        rcdto.RI_ProfessionId = 57;
